          ...
          <div className="max-w-3xl mx-auto w-full">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-left">
                    ...
                    >
                      ...
                      Your information is encrypted and protected. You'll
                      receive a confirmation email immediately after
                      registration with your event ticket and details.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-[#0E0E0E] border border-[#1F1F1F] rounded-xl sm:rounded-2xl p-6 sm:p-8">
              {submitMessage && submitMessage.type === "success" && (
                <div className="mb-6 bg-green-900/20 border border-green-500 rounded-xl p-6">
                    ...
                    <div className="flex-1">
                          ...
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <p
                                ...
                                style={{ letterSpacing: "0" }}
                              >
                                <strong>Immediately:</strong> Check your email
                                for registration confirmation and ticket details
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              ...
                              >
                                ...
                                payment via the link in your email within 24
                                hours
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <p
                                ...
                                style={{ letterSpacing: "0" }}
                              >
                                <strong>Event Day:</strong> Bring your ticket
                                (email or printed) and a valid ID
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start space-x-3">
                            ...
                            <div>
                              <p
                                ...
                                style={{ letterSpacing: "0" }}
                              >
                                <strong>Stay Updated:</strong> Follow us on
                                social media for event updates and reminders
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="flex flex-col sm:flex-row gap-3 mt-4">
                        <a
                          ...
                          className="inline-flex items-center justify-center px-4 py-2 bg-[#EB0028] rounded-lg text-white text-sm font-semibold hover:bg-[#c7001f] transition-all"
                          style={{ letterSpacing: "0", textDecoration: "none" }}
                        >
                          <svg
                        ...
                        <a
                          href="/agenda"
                          className="inline-flex items-center justify-center px-4 py-2 bg-[#1F1F1F] border border-[#EB0028] rounded-lg text-white text-sm font-semibold hover:bg-[#2F2F2F] transition-all"
                          style={{ letterSpacing: "0", textDecoration: "none" }}
                        >
                          <svg
                            className="w-4 h-4 mr-2"
                      ...
                      >
                        ...
                        <a
                          href="/contact"
                          className="text-[#EB0028] hover:underline"
                        >
                          contact support
                        </a>
                        .
