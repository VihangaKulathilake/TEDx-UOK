...
export const VolunteerApplicationPage:  React.FC = () => {
  ...
  const roles = [
    {
      ...
      description: 'Coordinate event setup, manage venues, and ensure smooth operations on event day.',
      icon: (
    ...
    },
    {
      ...
      description: 'Handle AV equipment, livestreaming, and technical troubleshooting.',
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      description: 'Welcome attendees, manage check-ins, and provide excellent customer service.',
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    },
    {
      ...
      description: 'Capture event moments, edit footage, and create visual stories.',
      icon: (
        <svg className="w-12 h-12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  const benefits = [
    ...
    {
      title: 'Free Access',
      description: 'Complimentary entry to the event and exclusive volunteer perks.',
      icon: (
        <svg className="w-16 h-16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="min-h-screen bg-black">
          ...
          <section className="py-20 px-4 bg-black">
            <div className="max-w-6xl mx-auto">
              <h2 className="text-3xl sm:text-4xl font-bold text-center mb-4" style={{ color: '#FFFFFF', letterSpacing: '0' }}>
              ...
              <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto" style={{ letterSpacing: '0' }}>
                Discover the various roles available and find the perfect fit for your skills and interests.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {roles.map((role, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-white mb-3" style={{ letterSpacing: '0' }}>{role.title}</h3>
                    <p className="text-gray-400 text-sm" style={{ letterSpacing: '0' }}>{role.description}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="py-20 px-4 bg-black">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-400 text-center mb-12" style={{ letterSpacing: '0' }}>
                Understand the time investment required throughout the event lifecycle.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {skills.map((skill, index) => (
                  ...
                  >
                    ...
                    <span className="text-gray-300" style={{ letterSpacing: '0' }}>{skill}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {benefits. map((benefit, index) => (
                  ...
                  >
                    <div className="text-white mb-4 flex justify-center">{benefit.icon}</div>
                    <h3 className="text-xl font-bold text-white mb-3" style={{ letterSpacing: '0' }}>{benefit.title}</h3>
                    <p className="text-gray-400 text-sm" style={{ letterSpacing: '0' }}>{benefit.description}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <section className="py-24 px-4 bg-black">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl sm:text-4xl font-bold mb-6" style={{ color: '#FFFFFF', letterSpacing: '0' }}>
